...
import { ArrowLeft, Briefcase, Save, Upload } from 'lucide-react';
            ...
            <div className="flex h-full flex-col gap-8 p-6 md:p-8 bg-black text-white">
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="font-serif text-3xl font-medium tracking-tight">Add Experience</h1>
                            <p className="text-white/60 text-sm">Add a new position to your professional journey</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="border border-white/10 bg-white/5 backdrop-blur-sm p-6">
                            ...
                            <div className="grid gap-4">
                                <div className="aspect-square max-w-[200px] bg-white/10 border border-white/10 flex items-center justify-center text-white/20">
                                    {data.company_logo ? (
                                        <img
                                ...
                                <Label htmlFor="company_logo" className="cursor-pointer">
                                    <div className="flex items-center justify-center gap-2 px-4 py-3 border border-white/10 hover:border-[#B5F482]/30 hover:bg-white/5 transition-all text-sm font-medium">
                                        ...
                                        {data.company_logo ? 'Change Logo' : 'Upload Logo'}
                                    </div>
                                    <Input
                                        id="company_logo"
                                        type="file"
