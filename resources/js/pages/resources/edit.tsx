...
import { ArrowLeft, FileText, Save, Trash, Upload, ExternalLink } from 'lucide-react';
            ...
            <form onSubmit={submit} className="flex h-full flex-col gap-8 p-6 md:p-8 bg-black text-white">
                ...
                <div className="flex items-center justify-between border-b border-white/10 pb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="font-serif text-3xl font-medium tracking-tight">Edit Resource</h1>
                            <p className="text-white/60 text-sm">Update resource information</p>
                        </div>
                    </div>
                        ...
                        <div className="border border-white/10 bg-white/5 backdrop-blur-sm p-6">
                            ...
                            <div className="grid gap-6">
                                ...
                                <div className="border border-white/10 bg-white/5 p-4">
                                    <div className="flex items-center justify-between">
                                        <span className="text-sm text-white/70">Total Downloads</span>
                                        <span className="text-lg font-bold text-[#B5F482]">{resource.download_count}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid gap-4">
                                ...
                                <Label htmlFor="thumbnail" className="cursor-pointer">
                                    <div className="flex items-center justify-center gap-2 px-4 py-3 border border-white/10 hover:border-[#B5F482]/30 hover:bg-white/5 transition-all text-sm font-medium">
                                        ...
                                        {data.thumbnail || resource.thumbnail ? 'Change Image' : 'Upload Image'}
                                    </div>
                                    <Input
                                        id="thumbnail"
                                        type="file"
